            ...
            <td class="post-title page-title column-title"><strong><?php echo $vid->video_title?></strong>
                <div class="row-actions">
					...
					<?php	if($vid->is_liked=='1'){ ?>
                        <span >
                            <a class="submitdelete" title="Remove Most Liked " href="<?php echo get_admin_url().'video.php?action=rliked&vid='.$vid->id.'&pager='.$id?>">Remove Most Liked</a>|
                        </span>
                    <?php }elseif($liked_count<18){ ?>
                        <span >
                            <a class="submitdelete" title="Make Most Liked" href="<?php echo get_admin_url().'video.php?action=liked&vid='.$vid->id.'&pager='.$id?>">Make Most Liked</a>|
                        </span>
                    <?php }else{ ?>
                        <span style="color:red;">
                            18 videos allowed in Most Liked |
                        </span>
					<?php } ?>                      
					...
					<?php	if($vid->is_featured=='1'){ ?>
                        <span >
                            <a class="submitdelete" title="Remove Featured" href="<?php echo get_admin_url().'video.php?action=rfeature&vid='.$vid->id.'&pager='.$id?>">Remove From New videos</a>|
                        </span>
                    <?php }elseif($feature_count<3){ ?>
                        <span >
                            <a class="submitdelete" title="Make Featured" href="<?php echo get_admin_url().'video.php?action=feature&vid='.$vid->id.'&pager='.$id?>">Make New videos</a>|
                        </span>
                    <?php }else{ ?>
                        <span style="color:red;">
                            3 videos allowed in New videos
                        </span>
					<?php } ?>                    
                </div>
            </td>
