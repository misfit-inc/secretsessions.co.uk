...
<div class="blog-posts">
    ...
    <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<?php 
			...
			$ttitle_encode = urlencode(html_entity_decode(get_the_title(), ENT_COMPAT, 'UTF-8'));
			
			$fb_link = 'https://www.facebook.com/sharer/sharer.php?u=' . $url_encode;
			$tw_link = 'https://twitter.com/intent/tweet?url=' . $url_encode . '&text=' . $ttitle_encode . '&via=Secret_Sessions';
		?>
