...
$videos = $wpdb->get_results("select * from videos where is_featured=1 order by id desc  limit $page,$limit;");
        ...
        <div class="video_thumb">
            ...
            <a href="<?php	echo add_query_arg('vid',$vid->id,get_permalink(get_page_by_path('show-video-2'))); ?>" class="title"
               title=""><?php echo stripslashes($vid->video_title); ?></a>
                ...
                ?>
            <p>by <a href="<?php echo $user_link; ?>" class="artist_name"
                     title=""><?php echo stripslashes(get_cimyFieldValue($vid->user_id, 'NAME')); ?></a></p>
        </div>
    </div>
<?php } ?>
