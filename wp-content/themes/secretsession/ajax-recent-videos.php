...
$videos = $wpdb->get_results("SELECT * FROM videos where videos.is_admin_added=1 order by id desc limit $page, $limit");
    ...
    <div class="col-md-4 col-sm-6 col-xs-12">
        <div class="video_thumb">
            ...
            <a href="<?php	echo add_query_arg('vid',$vid->id,get_permalink(get_page_by_path('show-video-2'))); ?>" class="title"
               title="">
                <?php
                    echo character_limiter(stripslashes($vid->video_title));
                ?>
            </a>
                ...
                if ($vid->user_id != 0) {
                    ...
                    <a href="<?php	echo $user_link; ?>"
                       class="artist_name" title="">
                        <?php echo character_limiter(stripslashes(get_cimyFieldValue($vid->user_id, 'NAME'))); ?>
                    </a>
                <?php
                } else {
                    ?>
